...
public class RentEntity {
    ...
    public String toString() {
        return "RentEntity{" + "id=" + id + ", fromDate=" + fromDate + ", toDate=" + toDate + ", total=" + total + ", isReturn=" + isReturn + ", balance=" + balance + ", refundableDeposit=" + refundableDeposit + ", advancedPayment=" + advancedPayment + ", perDayRent=" + perDayRent + ", carId=" + carId + ", customerId=" + customerId + '}';
    }
